...
/*
 * This peace of code is a rewrite of the code specified in the licence above
 */
...
public class Chart extends ApplicationFrame {
     ...
     */
    public Chart(final String title,WeatherData wd) {

        super(title);

        final XYDataset dataset = createDataset(wd);
