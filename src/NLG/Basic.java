...
public class Basic {
	...
	public String generateSentence(){
		...
		//Some basic text
		sb.append("At ").append(start.getValidTime()).append(" the temperature will be ").append(start.getT());
		...
		if(firstTrend.getTrend() == TrendPoint.Trend.POSITIVE){
			sb.append(" and incease to ").append(wd.getTimeseries().get(firstTrend.getIndex()).getT())
			  .append(" at ").append(wd.getTimeseries().get(firstTrend.getIndex()).getValidTime());
		}
		else {
